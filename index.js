...
const SUB_PATH = process.env.SUB_PATH || 'nnj''n'n';       // const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '27a9fd10-9eef-43b3-b55e-7476d99fc38e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
